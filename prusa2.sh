...
# -e 's|//#define SERVO_ENDSTOP_ANGLES.*|#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 74,0}|' \
# -e 's|//#define SERVO_ENDSTOP_DELAY.*|#define SERVO_ENDSTOP_DELAY {300, 300, 300}|' \
...
sed -i '' \
 -e '\|#define Z_HOME_RETRACT_MM|s|1|5|' ~/GIT/Marlin/Marlin/Configuration_adv.h
